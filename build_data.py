...
from data_utils import CoNLLDataset, get_vocabs, UNK, NUM, \
    get_glove_vocab, write_vocab, load_vocab, get_char_vocab, get_Pref_Suff_vocab, \
...
def build_data(config):
    ...
    vocab_pref_suff, vocab_pref_suff_2, vocab_pref_suff_4 = get_Pref_Suff_vocab(train)
    write_vocab(vocab_pref_suff, config.PS_filename)
    write_vocab(vocab_pref_suff_2, config.PS_filename_2)
    write_vocab(vocab_pref_suff_4, config.PS_filename_4)

    ####################################################################################################
    ### Build and save Pref_Suff vocab
